...
public class Test {
    ...
    public static void main(String[] args) {
        api = new BootpayApi("6024e5ee5b2948001d52037e", "n53GEUAuH4NuHjmsPhYJ5Um1N/Tf2K7eWy1w01iF7A8=");
        goGetToken();
        goVerfity();
        goCancel();
        goSubscribeBilling();
    ...
    public static void goVerfity() {
        try {
            HttpResponse res = api.verify("60261932d8c1bd0036f70ed2");
            String str = IOUtil.toString(res.getEntity().getContent(), "UTF-8");
    ...
    public static void goCancel() {
        ...
        cancel.receipt_id = "60261932d8c1bd0036f70ed2";
        cancel.name = "관리자 홍길동";
